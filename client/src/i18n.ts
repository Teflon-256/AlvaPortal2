...
const resources = {
  ...
  fr: {
    translation: {
      ...
      "signIn": "Se Connecter",
      "heroTitle": "AlvaCapital",
      "heroSubtitle": "Plateforme de Trading Professionnelle",
  ...
  de: {
    translation: {
      ...
      "signIn": "Anmelden",
      "heroTitle": "AlvaCapital",
      "heroSubtitle": "Professionelle Trading-Plattform",
  ...
  it: {
    translation: {
      ...
      "signIn": "Accedi",
      "heroTitle": "AlvaCapital",
      "heroSubtitle": "Piattaforma di Trading Professionale",
  ...
  pt: {
    translation: {
      ...
      "signIn": "Entrar",
      "heroTitle": "AlvaCapital",
      "heroSubtitle": "Plataforma de Trading Profissional",
  ...
  ru: {
    translation: {
      ...
      "signIn": "Войти",
      "heroTitle": "AlvaCapital",
      "heroSubtitle": "Профессиональная Торговая Платформа",
  ...
  ja: {
    translation: {
      ...
      "signIn": "サインイン",
      "heroTitle": "AlvaCapital",
      "heroSubtitle": "プロフェッショナル取引プラットフォーム",
  ...
  ar: {
    translation: {
      ...
      "signIn": "تسجيل الدخول",
      "heroTitle": "AlvaCapital",
      "heroSubtitle": "منصة التداول المهنية",
  ...
  hi: {
    translation: {
      ...
      "signIn": "साइन इन",
      "heroTitle": "AlvaCapital",
      "heroSubtitle": "प्रोफेशनल ट्रेडिंग प्लेटफॉर्म",
  ...
  tr: {
    translation: {
      ...
      "signIn": "Giriş Yap",
      "heroTitle": "AlvaCapital",
      "heroSubtitle": "Profesyonel İşlem Platformu",
  ...
  pl: {
    translation: {
      ...
      "signIn": "Zaloguj",
      "heroTitle": "AlvaCapital",
      "heroSubtitle": "Profesjonalna Platforma Handlowa",
  ...
  nl: {
    translation: {
      ...
      "signIn": "Inloggen",
      "heroTitle": "AlvaCapital",
      "heroSubtitle": "Professioneel Handelsplatform",
